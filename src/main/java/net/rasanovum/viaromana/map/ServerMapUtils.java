...
public final class ServerMapUtils {
    ...
    public static Set<ChunkPos> calculateFogOfWarChunks(List<DestinationResponsePacket.NodeNetworkInfo> networkNodes, ChunkPos minChunk, ChunkPos maxChunk) {
        ...
        for (DestinationResponsePacket.NodeNetworkInfo node : networkNodes) {
