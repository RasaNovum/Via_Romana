...
public class ToastPatchouliToast implements Toast {
	...
	public Visibility render(GuiGraphics guiGraphics, ToastComponent component, long lastChanged) {
		...
		guiGraphics.drawString(component.getMinecraft().font, Component.translatable("toasts.via_romana.toast_patchouli.title"), 30, 7, -11534256, false);
		guiGraphics.drawString(component.getMinecraft().font, Component.translatable("toasts.via_romana.toast_patchouli.description"), 30, 18, -16777216, false);
