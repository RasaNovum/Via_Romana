...
public class ToastPatchouliToast implements Toast {
	...
	public Visibility render(PoseStack poseStack, ToastComponent component, long lastChanged) {
		...
		font.draw(poseStack, Component.translatable("toasts.via_romana.toast_patchouli.title"), 30, 7, -11534256);
		font.draw(poseStack, Component.translatable("toasts.via_romana.toast_patchouli.description"), 30, 18, -16777216);
